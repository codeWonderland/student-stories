...
(function() {
  $(document).ready(function() {
    ...
    } else if (dataSource.getElementsByClassName('ss-video-thumb').length === 2) {
    ...
    tempHTML += '<p class="ss-quote">' + dataSource.getElementsByClassName('ss-quote')[0].innerHTML + '</p>' + '<a href="x36256"><img alt="call to action button" src="images/ace/student-stories-dev/gallery-button-01.jpg" onmouseover="this.src=\'images/ace/student-stories-dev/gallery-button-02.jpg\';" onmouseout="this.src=\'images/ace/student-stories-dev/gallery-button-01.jpg\'" /></a>';
  ...
  this.selectVid = function(video) {
    if ($('.video-wrapper').length > 1) {
      ...
      if (($(video).is('#video-left')) && (!$(video).hasClass('active'))) {
        ...
        document.getElementById('video-left').innerHTML = '<iframe class="ss-player" frameborder="0" height="562.5" src="https://player.vimeo.com/video/' + document.getElementsByClassName('student-profile')[0].getElementsByClassName('ss-video-link')[0].innerHTML + '?color=ffffff&amp;title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1" width="1000"></iframe>';
        ...
        document.getElementById('video-right').innerHTML = '<iframe class="ss-player" frameborder="0" height="562.5" src="https://player.vimeo.com/video/' + document.getElementsByClassName('student-profile')[0].getElementsByClassName('ss-video-link')[1].innerHTML + '?color=ffffff&amp;title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1" width="1000"></iframe>';
      }
    }
